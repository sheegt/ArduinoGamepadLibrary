...
**void Gamepad.begin(byte gamepadLayout, byte mcPins[], *bool fullPinout=false*)**

Setup the basic variables and call **Gamepad.setConnector()** with the given parameters.

**void Gamepad.setConnector(byte gamepadLayout, byte mcPins[], *bool fullPinout=false*)**
...
**void Gamepad.setPin(byte arrayID, byte pin, byte modePin, *byte initState=false*)**
